...
class Master_employee extends \App\Controllers\PrivateController
{
	/* Declare Model */
	private $MODEL;
	...
	public function __construct(\Slim\Container $container)
	{
		...
		/* Set Model */
		$this->MODEL = new \App\Models\Master_employee($container);
	}
	...
	public function create()
	{
		...
		$gump->validation_rules([
			"id_karyawan" => "numeric",
			"status_karyawan" => "numeric"
		]);

		$gump->filter_rules([
			"nama_karyawan" => "trim|sanitize_string",
			"alamat_karyawan" => "trim|sanitize_string"
		]);
