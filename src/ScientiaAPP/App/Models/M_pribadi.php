...
class M_pribadi extends \App\Plugin\DataTablesMysql
{
	...
	public function __construct(\Slim\Container $container)
	{
		...
		$this->TagName = hash('sha256', $this->Sign . 'M_pribadi');
	...
	/**
	 * Get Data in M_pribadi by Primary Key
	 *
	 * @param integer $id
	 * @return array
	 */
	...
	/**
	 * Remove single or multiple data from M_pribadi
	 *
