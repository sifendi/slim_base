...
class Master_employee extends \App\Plugin\DataTablesMysql
{
	...
	public function __construct(\Slim\Container $container)
	{
		...
		$this->TagName = hash('sha256', $this->Sign . 'Master_employee');
		$this->CacheExp = 3600; # in seconds (1 hour)

		/* Table Setup */
		$this->setTable('m_karyawan')
			->setColumns([
			'id_karyawan', 
			'nama_karyawan', 
			'alamat_karyawan', 
			...
			->setDefaultOrder(['id_karyawan'=> 'DESC' ]);
	}

	/**
	 * Get Data in Master_employee by Primary Key
	 *
	 * @param integer $id
	 * @return array
	 */
	...
	/**
	 * Retrieve data from Master_employee
	 *
	 * @param array $data
	 * @return array $output
	 */
	...
	/**
	 * Insert Data in Master_employee
	 *
	 * @param array $data
	...
	/**
	 * Update data from Master_employee
	 *
	 * @param array $data
	 * @param integer $id
	 * @return bool
	...
	/**
	 * Remove single or multiple data from Master_employee
	 *
