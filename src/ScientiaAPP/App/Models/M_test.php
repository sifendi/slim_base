...
class M_test extends \App\Plugin\DataTablesMysql
{
	...
	public function __construct(\Slim\Container $container)
	{
		...
		$this->TagName = hash('sha256', $this->Sign . 'M_test');
	...
	/**
	 * Get Data in M_test by Primary Key
	 *
	 * @param integer $id
	 * @return array
	 */
	...
	/**
	 * Remove single or multiple data from M_test
	 *
